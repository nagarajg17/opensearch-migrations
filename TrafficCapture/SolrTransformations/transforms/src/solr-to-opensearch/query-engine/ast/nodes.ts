 ...
 * produce a BareQueryNode instead.
 */
 ...
 *   `java` with df="content" → BareQueryNode { query: "java", isPhrase: false, defaultField: "content" }
 */
export interface BareQueryNode {
  type: 'bareQuery';
  /** The search query (term or phrase text, without quotes). */
  query: string;
