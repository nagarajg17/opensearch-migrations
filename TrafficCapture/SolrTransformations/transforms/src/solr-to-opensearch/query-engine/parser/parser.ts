 ...
 *   barePhrase ("text")          → BareQueryNode (isPhrase=true)
 *   bareValue (text)             → BareQueryNode (isPhrase=false)
 ...
 *   - Apply the default field (df) from params to BareQueryNode nodes
...
/** Walk the AST and resolve BareQueryNode default fields.
 *
 * For BareQueryNode (bare terms/phrases), sets the defaultField property
