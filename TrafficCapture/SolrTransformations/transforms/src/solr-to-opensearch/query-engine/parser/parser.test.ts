...
describe('parseSolrQuery', () => {
  ...
  describe('BoostNode', () => {
    ...
    it('resolves df through boost on bare value', () => {
      ...
      expect(ast).toEqual({
        type: 'boost',
        child: { type: 'bareQuery', query: 'java', isPhrase: false, defaultField: 'title' },
        value: 2,
      });
    });
    ...
    it('parses boost on bare phrase', () => {
      ...
      expect(ast).toEqual({
        type: 'boost',
        child: { type: 'bareQuery', query: 'hello world', isPhrase: true, defaultField: 'content' },
        value: 2,
      });
    });
  });
        ...
        and: [
          ...
          },
          {
            type: 'bool', and: [], or: [], not: [
              { type: 'bareQuery', query: 'hello world', isPhrase: true, defaultField: 'content' },
            ],
          },
        ],
        or: [],
